          ...
          <Grid item xs={12} md={6}>
            <SubCard title="Phone no.">
              <Grid container alignItems="center" spacing={3}>
                ...
                <Grid item xs={12}>
                  <NumberFormat format="+91 #### ###-####" mask="_" fullWidth customInput={TextField} label="Contact Number" />
                </Grid>
                <Grid item xs={12}>
                  <NumberFormat format="(##) ####-#####" mask="_" fullWidth customInput={TextField} label="Tel. with Code Area" />
                </Grid>
                <Grid item xs={12}>
                  <NumberFormat format="(###) ### #####" mask="_" fullWidth customInput={TextField} label="US Telephone" />
                </Grid>
              </Grid>
            </SubCard>
          </Grid>
          <Grid item xs={12} md={6}>
            <SubCard title="Network">
              <Grid container alignItems="center" spacing={3}>
                ...
                <Grid item xs={12}>
                  <NumberFormat format="####:####:####:#:###:####:####:####" mask="_" fullWidth customInput={TextField} label="IPV6" />
                </Grid>
              </Grid>
            </SubCard>
          </Grid>
