  ...
  return (
    <Html>
      <Head>
        ...
        <meta name="title" content="Council of Social Workers" />
        <meta
          name="description"
          content="Council of Social Workers is the regulatory board for the Social Work Profession in Zimbabwe established in terms of the Social Workers Act 27:21."
        />
        <meta
          name="keywords"
